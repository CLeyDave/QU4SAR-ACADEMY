  ...
  for(var d=0;d<7;d++){
    ...
    if(dayEvents.length){
      dayEvents.forEach(function(e){
        html+='<div class="schedule-card '+e.type+'"><div class="sc-head"><span class="title">'+esc(e.title)+'</span><span class="type-badge">'+esc(e.type)+'</span></div><div class="sc-time">'+ic('clock',14)+' '+e.start+' - '+e.end+'</div>'+(e.coach?'<div class="sc-coach">'+ic('user',14)+' '+esc(e.coach)+'</div>':'')+'</div>';
      });
    }else{
