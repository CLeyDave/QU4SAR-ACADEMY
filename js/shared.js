...
function initParticles(){
  ...
  for(var i=0;i<c;i++){
    ...
    p.style.animation='floatStar '+dur+'s '+delay+'s linear infinite';
    p.style.boxShadow=size>1.5?'0 0 '+(size*3)+'px '+p.style.background:'none';
    p.style.opacity=Math.random()*0.6+0.15;
