...
async function loadAdminData(){
  ...
  }catch(ee){console.log('loadAdminData failed:',ee);DATA=getData();document.getElementById('adminDbStatus').innerHTML='<i data-lucide="wifi-off" style="width:12px;height:12px;vertical-align:middle"></i> <span>desconectado</span>';document.getElementById('adminDbStatus').className='err';if(typeof lucide!=='undefined')lucide.createIcons()}
